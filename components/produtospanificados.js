...
const products = [
  { id: '1', name: 'Pão Puma', price: 8.99, image: require('./assets/banana.png') },
  { id: '2', name: 'Bisnaguinha Panco', price: 7.99, image: require('./assets/bisnaguinha.png') },
  { id: '3', name: 'Bolo Puma/sabor chocolate', price: 8.99, image: require('./assets/manga.png') },
  { id: '4', name: 'Bolo Puma/sabor laranja', price: 8.99, image: require('./assets/laranja.png') },
  { id: '5', name: 'Oreo', price: 3.50, image: require('./assets/uva.png') },
  { id: '6', name: 'Trakinas', price: 3.00, image: require('./assets/limao.png') },
